  ...
  <div class="department-info">
    <div class="deptment-info">
      <div class="deptment-info-btns">
        ...
        <div class="edit">
          <div style="color: #154ad8" v-show="selectItem.id !== rootElement.id" @click="showDialog"
            >分配人员</div
          >
        </div>
      </div>
    ...
    <el-dialog v-model="dialogVisible" title="分配人员" width="450px" center>
      <el-select-v2
...
<script lang="ts" setup>
  ...
  const remoteMethod = (query: string) => {
    if (query !== '') {
      loading.value = true
      let arr = options.value.filter((item) => {
