  ...
  <el-card class="getApp">
    <div class="getApp-container">
      ...
      <div class="getApp-content">
        <AppCard v-if="modeType === 'card'" ref="appCard" :dataList="state.myAppList" type="shop"
          @handleUpdate="handleUpdate" @shopcarNumChange="getShopcarNum"></AppCard>

        <Pagination v-if="modeType === 'card'" ref="pageContent" @handleUpdate="handleUpdate"></Pagination>
        <DiyTable v-else ref="diyTable" :hasTitle="true" :tableData="state.myAppList" :tableHead="tableHead"
