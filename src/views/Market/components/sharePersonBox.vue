  ...
  <div class="cohortLayout">
    ...
    <div class="cohortLayout-content">
      <div class="cohortLayout-content-left" :style="'width:' + (radio == '1' ? '49%' : '33%')">
        ...
        <el-tree v-if="radio == '1'" ref="leftTree" node-key="id" :data="cascaderTree" :props="unitProps"
          :check-strictly="true" :default-expand-all="true" show-checkbox @check-change="handleCheckChange"
          :filter-node-method="filterNode" />
        <el-tree v-else ref="leftTree" :data="cascaderTree" :key="radio" :props="unitProps" :highlight-current="true"
