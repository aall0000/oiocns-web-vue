  ...
  <div class="cohortLayout">
    ...
    <div class="cohortLayout-content">
      <div class="cohortLayout-content-left" :style="'width:' + (radio == '1' ? '49%' : '33%')">
        ...
        <el-tree v-if="radio == '1'" ref="leftTree" node-key="id" :data="cascaderTree"
          :props="{ class: customNodeClass }" :check-strictly="true" :default-expand-all="true" show-checkbox
          @check-change="handleCheckChange" :filter-node-method="filterNode" />
        <el-tree v-else ref="leftTree" :data="cascaderTree" :key="radio" :highlight-current="true"
      ...
      <div class="cohortLayout-content-right" :style="'width:' + (radio == '1' ? '49%' : '33%')">
        ...
        <Author v-if="radio == '3'" @delContent="delContentAuth" :departData="state.personsData"></Author>
        <Author v-if="radio == '4'" @delContent="delContentAuth" :departData="state.identitysData"></Author>
      </div>
    </div>
