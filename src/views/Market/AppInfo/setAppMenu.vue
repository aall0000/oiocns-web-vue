    ...
    >
      ...
      <div class="custom-title">
        ...
        <el-icon
          ...
          class="add-btn"
          :size="20"
          @click.stop="handleAddMenu('Add', menuIndex)"
        >
          <CirclePlus />
        </el-icon>
      </div>
      ...
      >
        <li class="menu-item flex">
          <div :class="['menu-label', readOnly ? '' : 'required']">业务信息:</div>
          <el-input
            placeholder="请设置流程名称"
            v-model="item.name"
            :readonly="readOnly"
        ...
        >
          <li class="menu-item flex">
            <div :class="['menu-label', readOnly ? '' : 'required']">字段名称:</div>
            <el-input
              placeholder="请设置字段名称"
              v-model="fItem.key"
              :readonly="readOnly"
          ...
          <li class="menu-item flex">
            <div :class="['menu-label', readOnly ? '' : 'required']">字段编号:</div>
            <el-input
              placeholder="请设置字段编号"
              v-model="fItem.code"
              :readonly="readOnly"
          ...
          <li class="menu-item flex">
            <div :class="['menu-label', readOnly ? '' : 'required']">字段类型:</div>
            <el-select :disabled="readOnly" v-model="fItem.type" class="m-2" placeholder="Select">
              <el-option
      ...
      <div class="custom-title">
        ...
        <el-icon
          ...
          class="add-btn"
          :size="20"
          @click.stop="handleAddComponents('Add', menuIndex)"
        >
          <CirclePlus />
        </el-icon>
      </div>
      ...
      >
        <li class="menu-item flex">
          <div :class="['menu-label', readOnly ? '' : 'required']">组件名称:</div>
          <el-input
            placeholder="请设置流程名称"
        ...
        <!-- 共有部分 -->
        <li class="menu-item flex">
          <div :class="['menu-label', readOnly ? '' : 'required']">链接地址:</div>
          <el-input
            placeholder="请设置链接地址"
            v-model="comItem.url"
            :readonly="readOnly"
        ...
        <li class="menu-item flex">
          <div :class="['menu-label', readOnly ? '' : 'required']">组件宽度:</div>
          <el-input
            placeholder="请设置宽度"
        ...
        <li class="menu-item flex">
          <div :class="['menu-label', readOnly ? '' : 'required']">组件高度:</div>
          <el-input
            placeholder="请设置高度"
...
<script lang="ts" setup>
  ...
  const handlFieldMenu = (
    ...
    emit('handlFieldMenu', type, index, fIndex, selectId)
  }
